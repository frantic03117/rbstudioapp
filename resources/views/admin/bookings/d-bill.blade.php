                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td colspan="7"
                                            ...
                                            <h4 style="margin-bottom: 0;">Customer Details</h4>
                                        </td>
                                        <td colspan="5" style="font-size:14px;">
                                            <h4 style="margin-bottom: 0;">Receipt Details</h4>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="7">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="4" style="text-align: right;">
                                            ₹ {{ $remainingamount = floor($booking->balance) }}
