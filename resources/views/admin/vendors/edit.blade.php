        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="w-100">
                        {!! Form::open(['route' => ['vendor.update', $vendor->id], 'method' =>'PUT', 'files' => 'true']) !!}
                        <div class="row gy-4 ">
                            ...
                            <div class="col-md-3">
                                ...
                                {!! Form::text('bill_prefix', $vendor['bill_prefix'], ['class' => 'form-control']) !!}
                            </div>
                            ...
                            <div class="col-md-2">
                                ...
                                <select name="country_id" onchange="getStates(event)" id="country_id" class="form-select">
                                    ...
                                    @foreach ($countries as $c)
                                        <option value="{{ $c->id }}" @selected($c->id == $vendor['country_id'])>{{ $c->country }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-2">
                                ...
                                <select name="state_id" onchange="getCity(event)" id="state_id" class="form-select">
                                    ...
                                    @foreach ($states as $st)
                                        <option value="{{$st->id}}" @selected($st->id == $vendor->state_id)>{{$st->state}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-2">
                                ...
                                <select name="district_id" id="city_id" class="form-select">
                                    <option value="" selected @disabled(true)>---Select---</option>
                                    @foreach ($cities as $c)
                                            <option value="{{$c->id}}" @selected($c->id == $vendor->district_id)>{{$c->city}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-2">
                                <label for="">Enter Pincode</label>
                                {!! Form::text('pincode', $vendor['pincode'], ['class' => 'form-control', 'minlength' => '6', 'maxlength' => '6']) !!}
                            </div>
                            <div class="col-md-4">
                                <label for="">Enter Google Map URL</label>
                                {!! Form::text('google_map', $vendor['google_map'], ['class' => 'form-control']) !!}
                            </div>
                            <div class="col-md-12">
                                <label for=""></label>
