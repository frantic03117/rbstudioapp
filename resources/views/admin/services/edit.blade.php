            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="w-100 mb-3 text-end">
                        <a href="{{ route('services.index') }}" class="btn btn-gradient">Back
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-floating mb-3">
                                    ...
                                    {!! Form::text('name', $service['name'], ['class' => 'form-control', 'id' => 'title']) !!}
                            ...
                            <div class="col-md-4">
                             ...
                             <div class="col-md-4">
                                <div class="form-check form-switch form-switch-lg mb-3" dir="ltr">
                                    ...
                                    <label class="form-check-label" for="customSwitchsizelg">Is Approval Required</label>
                                </div>
                            </div>
                            <div class="col-md-12 mb-3">
                                <label for="">Enter Description</label>
                                {!! Form::textarea('description', $service['description'], ['id' => 'editor']) !!}
                                <script>
